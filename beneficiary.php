...
<body>
    ...
    <div class="search-bar" id="the-search-bar">
       ...
       <a class="add-button" href="add_beneficiary.php">Ajouter</a>
                ...
                <form class="search_form" action="" method="post">
                 ...
                 <div class="flex-item-search-by">
                        <select name="by" id="by">
                         ...
                         <option value="acno">Numero Compte</option>
                        </select>
                    </div>
                </form>
    ...
    <div class="flex-container">
        <p id="info">Envoyer a , Ajouter/supprimer Beneficiaries.</p>
...
<p id="id"><?php echo $i . "."; ?></p>
   ...
   <button onclick="dropdown_func(<?php echo $i ?>)" class="dropbtn"></button>
     ...
     <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                         ...
                         <a href="send_funds.php?cust_id=<?php echo $row1["cust_id"] ?>">Envoyer</a>
  ...
  onclick="return confirm('Are you sure?')">Supprimer</a>
         ...
         if ($isBenefPresent == 0) { ?>
                <p id="none"> Pas de beneficiaries trouver :(</p>
            <?php }
            if ($back_button) { ?>
  ...
  <a href="beneficiary.php" class="button">Revenir en arriere</a>
                    </div>
                </div>
