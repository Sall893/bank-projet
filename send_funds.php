...
<body>
 ...
 <form class="add_customer_form" action="send_funds_action.php?cust_id=<?php echo $id ?>" method="post">
    ...
    <div class="flex-container-form_header">
            <h1 id="form_header">Transferer des fonds</h1>
        </div>
...
To : <label id="info_label">
   ...
   <div class=container>
                <label>Numero de compte: <label id="info_label"><?php echo $row0["account_no"] ?></label></label>
  ...
  <label>Saisir le montant :</label><br>
     ...
     <label>Saisir votre mot de passe :</b></label><br>
