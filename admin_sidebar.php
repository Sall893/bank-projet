...
<body>
    <div class="sidenav" id="theSideNav">
     ...
     <a href="javascript:void(0)" id="closebtn" onclick="closeNav()">&times;</a>
        <a href="admin_home.php">Acceuil</a>
   
     <a id="label">Mes clients</a>
        <a href="customer_add.php">Ajout Client</a>
        <a href="manage_customers.php">Gestion Client</a>
   
     <a id="label">Gestion Site</a>
        <a href="post_news.php">Poster Nouvelles</a>
    </div>
