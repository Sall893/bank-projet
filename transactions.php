...
<div class="search-bar-wrapper">
       ...
       <button id="search" onclick="document.getElementById('id01').style.display='block'">Filtrer</button>

                <div class="flex-item-by">
                    <label id="sort">Trier par :</label>
                </div>
 ...
 <option value="transactions.php?sort=date_up">Date &uarr;</option>
    ...
    <div id="id01" class="modal">
     ...
     <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Filter">&times;</span>
       ...
       <div class="container">
            <h1 id="filter">Filtrer</h1>
            <p id="filter">(Laisser vide pour enlever le filtre)</p>
     
     <label>Trans. Remarques :</label>
          <input type="text" placeholder="Enter Remarks" name="search_term">

         
 <label>Duree (yyyy-mm-dd) :</label>
       ...
       <div class="date-container">
          ...
          <button id="submit" type="submit">Aller</button>
        </div>
  ...
  <p id="none">Filtrer : <?php echo $filter_indicator ?></p>
    </div>
...
$sanitized_time = date("d/m/Y, g:i A", $time);
 ...
 <?php } ?>
            ...
            <?php
                ...
                <p id="none"> Pas de resultats trouver :(</p>
