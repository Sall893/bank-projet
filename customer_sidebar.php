...
<body>
    ...
    <a href="javascript:void(0)" id="closebtn" style="padding: 10px 20px;"
      ...
      <a href="customer_home.php">Acceuil</a>
        <a href="customer_transactions.php">Mes Transactions</a>
        <a id="label">Envoyer/Recevoir</a>
      
  <a href="beneficiary.php">Fonds de transfert</a>
        <a href="atm_simulator.php">Simulateur ATM (retrait)</a>
