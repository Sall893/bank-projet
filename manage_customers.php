   ...
   if ($result->num_rows > 0) 
{
  ...
  <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                         ...
                         <a href="edit_customer.php?cust_id=<?php echo $row["cust_id"] ?>">Voir / Modifier</a>
 ...
 onclick="return confirm('Are you sure?')">Supprimer</a>
            ...
            <?php }
                ...
                <p id="none"> Pas de resultats trouvé :(</p>
            <?php }
            if ($back_button) { ?>
                <div class="flex-container-bb">
 
                   <div class="back_button">
                        <a href="manage_customers.php" class="button">Retour</a>
                    </div>
