...
<body>
 ...
 <div class="nav-wrapper">
  ...
  <a href="javascript:void(0);" class="icon" onclick="openNav()" id="hamburger">
            ...
            <a id="user">Bienvenue, &nbsp<?php echo $row["first_name"]; ?> !</a>
     
       <a id="logout" href="logout_action.php" onclick="return confirm('Are you sure?')">Deconexion</a>
          
  <a id="profile" href="customer_profile.php">Mon Profil</a>
        </div>
    </div>
